...
\begin{figure}[ht]
	\begin{center}
		\includegraphics[width=0.40\textwidth]{chapters/chapter5/fig/holo2}
	\end{center}
	\caption{Holistic Scheduler Model}
	\label{fig:Holo2}
\end{figure}
